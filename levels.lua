...
Levels = {
    ...
    {name="push apart", map_loc={64,16}, inventory={Id_default_planet_sprite, Id_default_planet_sprite}, angle=0, hint="orange planets push away"},
    {name="black hole run", map_loc={80,16}, inventory={}, angle=0, hint="black holes pull and survive"},
    {name="cloud navigation", map_loc={96,16}, inventory={Id_repulse_planet_sprite}, angle=0.055, hint="thread blue, avoid red/purple"},
    {name="space sampler", map_loc={112,16}, inventory={Id_repulse_planet_sprite}, angle=0, hint="thread the fields and clouds"}
}
